...
class CarsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ->scalar('car_reg_no')
            ->maxLength('car_reg_no', 100)
            ->requirePresence('car_reg_no', 'create')
            ->notEmptyString('car_reg_no');

        $validator
            ->scalar('car_num_plate')
            ->maxLength('car_num_plate', 100)
            ->requirePresence('car_num_plate', 'create')
            ->notEmptyString('car_num_plate');
